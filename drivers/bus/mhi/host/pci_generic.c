...
static const struct mhi_channel_config mhi_telit_fe990b_channels[] = {
	MHI_CHANNEL_CONFIG_UL_SBL(2, "SAHARA", 32, 0),
	MHI_CHANNEL_CONFIG_DL_SBL(3, "SAHARA", 32, 0),
	MHI_CHANNEL_CONFIG_UL(4, "DIAG", 64, 1),
	MHI_CHANNEL_CONFIG_DL(5, "DIAG", 64, 1),
...
static const struct mhi_controller_config modem_telit_fe990b_config = {
	...
	.timeout_ms = 20000,
	.ready_timeout_ms = 50000,
	.num_channels = ARRAY_SIZE(mhi_telit_fe990b_channels),
	.ch_cfg = mhi_telit_fe990b_channels,
	.num_events = ARRAY_SIZE(mhi_telit_fn990_events),
	.event_cfg = mhi_telit_fn990_events,
};
...
static const struct mhi_pci_dev_info mhi_telit_fn990b_info = {
	.name = "telit-fn990b",
	.config = &modem_telit_fe990b_config,
	.bar_num = MHI_PCI_DEFAULT_BAR_NUM,
	.dma_data_width = 32,
...
static const struct pci_device_id mhi_pci_id_table[] = {
	...
	{ PCI_DEVICE_SUB(PCI_VENDOR_ID_QCOM, 0x0309, 0x1c5d, 0x201a),
		.driver_data = (kernel_ulong_t) &mhi_telit_fn990b_info },
